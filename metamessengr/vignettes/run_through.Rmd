...
We can also plot the density of the sentiment scores before and after the event as well. The default for this plot is to facet wrap by sender, but the function argument `wrap_by=` 
